...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do{
            ...
            genres.add(new Action());
            genres.add(new Adventure());
            genres.add(new Comedy());
            genres.add(new Thriller());

            logger.info("Kreirana lista žanrova, dodani žanrovi: Action, Adventure, Comedy, Thriller");
